package com.sclasen.akka.aws.s3
...
class S3Client(val props: S3ClientProps) extends AkkaAWSClient(props) {

  import com.sclasen.akka.aws.s3.MarshallersAndUnmarshallers._
