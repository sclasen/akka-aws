package com.sclasen.akka.aws.route53

import akka.util.Timeout
import akka.actor.{ ActorRefFactory, ActorSystem }
import akka.stream.ActorMaterializer
import com.amazonaws.internal.StaticCredentialsProvider
import com.sclasen.akka.aws.{ AkkaAWSClient, AkkaAWSClientProps }
...
case class Route53ClientProps(credentialsProvider: AWSCredentialsProvider, operationTimeout: Timeout, system: ActorSystem, factory: ActorRefFactory, materializer: ActorMaterializer, endpoint: String) extends AkkaAWSClientProps {
  val service = "route53"
}
...
class Route53Client(val props: Route53ClientProps) extends AkkaAWSClient(props) {
