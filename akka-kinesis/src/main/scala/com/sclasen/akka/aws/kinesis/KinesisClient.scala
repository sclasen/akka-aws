package com.sclasen.akka.aws.kinesis
...
import com.sclasen.akka.aws._

import scala.collection.JavaConverters._
import scala.concurrent.Future

case class KinesisClientProps(credentialsProvider: AWSCredentialsProvider, operationTimeout: Timeout, system: ActorSystem, factory: ActorRefFactory, materializer: ActorMaterializer, endpoint: String) extends AkkaAWSClientProps {
  val service = "kinesis"
}
...
class KinesisClient(val props: KinesisClientProps) extends AkkaAWSClient(props) {

  import com.sclasen.akka.aws.kinesis.MarshallersAndUnmarshallers._
