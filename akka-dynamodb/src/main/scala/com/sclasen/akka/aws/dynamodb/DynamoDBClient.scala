package com.sclasen.akka.aws.dynamodb
...
case class DynamoDBClientProps(credentialsProvider: AWSCredentialsProvider, operationTimeout: Timeout, system: ActorSystem, factory: ActorRefFactory, materializer: ActorMaterializer, endpoint: String) extends AkkaAWSClientProps {
...
class DynamoDBClient(val props: DynamoDBClientProps) extends AkkaAWSClient(props) {
