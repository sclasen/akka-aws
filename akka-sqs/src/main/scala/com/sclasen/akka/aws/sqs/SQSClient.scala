package com.sclasen.akka.aws.sqs
...
case class SQSClientProps(credentialsProvider: AWSCredentialsProvider, operationTimeout: Timeout, system: ActorSystem, factory: ActorRefFactory, materializer: ActorMaterializer, endpoint: String) extends AkkaAWSClientProps {
  val service = "sqs"
}
...
class SQSClient(val props: SQSClientProps) extends AkkaAWSClient(props) {
